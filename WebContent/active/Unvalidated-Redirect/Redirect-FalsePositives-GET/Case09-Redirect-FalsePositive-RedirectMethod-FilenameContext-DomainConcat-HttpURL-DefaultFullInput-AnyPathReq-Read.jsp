...
<body>
	...
	<%
		...
		//HTTP_INPUT_VALIDATION,HTTP_INPUT_REMOVAL, CONCAT_DOMAIN_BASE_URL
		accessRestriction = FileAccessRestriction.CONCAT_DOMAIN_BASE_URL;
	...
	<%@ include file="inclusion-logic3.jsp"%>